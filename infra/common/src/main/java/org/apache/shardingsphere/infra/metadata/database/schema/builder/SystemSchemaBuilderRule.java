...
public enum SystemSchemaBuilderRule {
    ...
    POSTGRESQL_PG_CATALOG("PostgreSQL", "pg_catalog", new HashSet<>(Arrays.asList("pg_aggregate", "pg_am", "pg_amop", "pg_amproc", "pg_attrdef", "pg_class", "pg_database", "pg_inherits",
            "pg_largeobject", "pg_largeobject_metadata", "pg_namespace", "pg_opclass", "pg_operator", "pg_opfamily", "pg_tablespace", "pg_trigger", "pg_range", "pg_replication_origin", "pg_rewrite",
            "pg_seclabel", "pg_sequence", "pg_roles", "pg_tables", "pg_user_mapping"))),
